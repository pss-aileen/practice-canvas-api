'use strict';
{
  ...
  */
  ...
  if (canvas.getContext) {
    ...
    // TODO: 画面外にでて、勝手にペンがおわると案外うっとおしい。
    // 画面外に出てもいいけど、外部でマウスをはなしたらきちんとisDrawingが取れるようにしたい
    // 次でOK
    ...
    /* 
      ...
      [PROBLEM] マウスダウンして、クリックした時だけでも絵をかけるようにしたいけど、moveTo、lineTo使っても点ができない
      - 解決: stroke()を書いて解決。描画してなかったからできなかった。
    */
